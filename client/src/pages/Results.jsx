...
import { MapPin, Calendar, Users, DollarSign, Clock, Star, Cloud, Hotel, Car, Plane, Send, Bot, User, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50 to-green-100">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <Button className="bg-gradient-to-r from-[#2e7f43] to-[#6da57b] hover:from-[#245f35] hover:to-[#5a8f66] text-white">
                Get Started
              </Button>
            </div>
            ...
            <div className="md:hidden bg-white border-t py-4">
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-2 pt-4 border-t">
                  ...
                  <Button className="bg-gradient-to-r from-[#2e7f43] to-[#6da57b] text-white">
                    Get Started
                  </Button>
                </div>
              </div>
      ...
      <div className="w-full bg-gradient-to-r from-[#2e7f43] to-[#6da57b] text-white">
        <div className="container flex">
          ...
          {/* Right Header - Travel Assistant (40% width) */}
          <div className="w-2/5 py-4 px-6 flex items-center">
